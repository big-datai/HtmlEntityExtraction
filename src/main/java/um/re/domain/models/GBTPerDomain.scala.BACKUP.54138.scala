...
object GBTPerDomain extends App {
  ...
  val list = List("thesupplementstore.co.uk")

  //list of domains 
  //TODO create list of domains that are relevant
<<<<<<< HEAD:src/main/java/um/re/models/GBTPerDomain.scala
...
>>>>>>> 16bf2a99ef85fabc22c0444179de8ad0e68fba8f:src/main/java/um/re/domain/models/GBTPerDomain.scala
